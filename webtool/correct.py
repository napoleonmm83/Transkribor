...
- UNSICHER: wirklich unklare Stellen NICHT raten — nah am Original belassen und unter annotations vermerken. {WIDERSPRUCH_REGEL} AN EINER SOLCHEN WIDERSPRUCHS-STELLE ist nur eine unter annotations als AUFLÖSUNG vermerkte Abweichung KEINE Drift: die NICHT zurückdrehen, auch wenn sie vom Roh abweicht — prüfe nur, ob sie zum Klang des Rohs passt; passt sie NICHT, stelle den Rohstand wieder her und vermerke die Stelle als UNGEKLÄRT. Eine Abweichung DORT ohne solchen Vermerk geht ebenfalls zurück; gewöhnliche ASR-Korrekturen ausserhalb eines Widerspruchs beurteilst du unverändert nach den Punkten oben. Und ein Vermerk, der den Widerspruch WEGERKLÄRT (Wortspiel, Scherz, Ironie), ist keine Auflösung: stelle den Rohstand wieder her und vermerke die Stelle als UNGEKLÄRT. Entferne evtl. übrige [[...]]-Markierungen im Text.
