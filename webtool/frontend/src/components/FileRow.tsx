...
export function FileRow({ project, file, active, onOpen, phase, state, jobRunning, inScope, globalPhase, aiReason }: {
  ...
  return (
    <div onClick={onOpen} role="button" tabIndex={0} aria-label={`Datei ${file.base} öffnen`}
      ...
      <FileStatusPill file={file} active={phase} state={state} jobRunning={jobRunning} inScope={inScope} globalPhase={globalPhase} />
