...
const BASIS = {
  ...
  providers: [], ai_ready: true, ai_reason: '', kaputt: '',
  ytdlp_auto: '1', ytdlp: { unlesbar: false, version: '2026.8.12', geprueft: '', auto: true, env: false, laeuft: false, ergebnis: '', ungeschuetzt: false, ejs_unlesbar: false },
} as Settings
