...
**Immer einen Schritt zurück.** Hast du eine Aufnahme offen, führt dich der Pfeil links oben
...
etwa zehn Minuten alt sind; startest du kurz nach dem Abbruch neu, bleiben sie also noch einen
Start liegen.
...
beim Namen genannt, und der Lauf arbeitet mit den übrigen **geeigneten** Aufnahmen weiter —
„geeignet“ heisst: alles, was er auch sonst anfassen würde. Eine von Hand bearbeitete Aufnahme
lässt er weiterhin in Ruhe (ausser du wählst ausdrücklich „Neu korrigieren“), und eine Aufnahme,
deren Tonspur inzwischen ausgetauscht wurde, überspringt er ebenfalls.
